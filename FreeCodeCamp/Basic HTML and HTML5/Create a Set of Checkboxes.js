...
<main>
    ...
    <form action="https://www.freecatphotoapp.com/submit-cat-photo">
        <label htmlFor="1"><input id="outdoor" type="checkbox" name="personality"> 1</label>
        <label htmlFor="2"><input id="outdoor" type="checkbox" name="personality"> 2</label>
        <label htmlFor="3"><input id="outdoor" type="checkbox" name="personality"> 3</label>
